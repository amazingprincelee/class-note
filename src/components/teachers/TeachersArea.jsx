            ...
            <div className="row">
                ...
                <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 className="h2" style={{ borderBottom: "5px solid orange" }}>Teacher's Area</h1>
                    </div>


                    <div className="container">
                        <h2>Welcome to The Teacher's Area</h2>
                        <p>Please use the form below to submit your courses and upload your files.</p>
                    </div>
                    <form className="my-4">
                        <div className="row">
